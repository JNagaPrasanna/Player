...
const WebVTTParser = {
    parse: <span class="fstat-no" title="function not covered" >fu</span>nction(vttByteArray, syncPTS, vttCCs, cc, callBack, errorCallBack) {
        ...
        let vttLines = <span class="cstat-no" title="statement not covered" >new Uint8Array(vttByteArray)</span>
          .reduce(<span class="fstat-no" title="function not covered" >(r</span>aw, vttByte) =&gt; <span class="cstat-no" title="statement not covered" >raw + String.fromCharCode(vttByte),</span> '')
          .trim().replace(re, '\n').split('\n');
&nbsp;
